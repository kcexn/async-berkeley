...
TEST_F(SocketHandleTest, ConnectTagInvokeSuccessfulConnection) {
...
TEST_F(SocketHandleTest, ConnectTagInvokeConnectionRefused) {
  socket_handle client_socket(AF_INET, SOCK_STREAM, IPPROTO_TCP);
...
TEST_F(SocketHandleTest, ConnectTagInvokeInvalidSocket) {
...
TEST_F(SocketHandleTest, AcceptTagInvokeInvalidSocket) {
  socket_handle invalid_socket;
...
TEST_F(SocketHandleTest, AcceptTagInvokeNotListening) {
...
TEST_F(SocketHandleTest, SendmsgTagInvokeInvalidSocket) {
  socket_handle invalid_socket;
...
TEST_F(SocketHandleTest, RecvmsgTagInvokeBasicReceive) {
  socket_handle server_socket(AF_INET, SOCK_STREAM, IPPROTO_TCP);
  socket_handle client_socket(AF_INET, SOCK_STREAM, IPPROTO_TCP);
...
TEST_F(SocketHandleTest, RecvmsgTagInvokeInvalidSocket) {
  socket_handle invalid_socket;
...
TEST_F(SocketHandleTest, GetsockoptTagInvokeBasicGet) {
  socket_handle socket(AF_INET, SOCK_STREAM, IPPROTO_TCP);
...
TEST_F(SocketHandleTest, GetsockoptTagInvokeInvalidSocket) {
  socket_handle invalid_socket;
...
TEST_F(SocketHandleTest, SetsockoptTagInvokeBasicSet) {
  socket_handle socket(AF_INET, SOCK_STREAM, IPPROTO_TCP);
...
TEST_F(SocketHandleTest, SetsockoptTagInvokeInvalidSocket) {
  socket_handle invalid_socket;
...
TEST_F(SocketHandleTest, GetsocknameTagInvokeBasicGet) {
  socket_handle socket(AF_INET, SOCK_STREAM, IPPROTO_TCP);
...
TEST_F(SocketHandleTest, GetsocknameTagInvokeInvalidSocket) {
  socket_handle invalid_socket;
...
TEST_F(SocketHandleTest, GetpeernameTagInvokeSuccessfulGet) {
  socket_handle server_socket(AF_INET, SOCK_STREAM, IPPROTO_TCP);
  socket_handle client_socket(AF_INET, SOCK_STREAM, IPPROTO_TCP);
...
TEST_F(SocketHandleTest, GetpeernameTagInvokeNotConnected) {
  socket_handle socket(AF_INET, SOCK_STREAM, IPPROTO_TCP);
...
TEST_F(SocketHandleTest, ShutdownTagInvokeSuccessfulShutdown) {
  socket_handle server_socket(AF_INET, SOCK_STREAM, IPPROTO_TCP);
  socket_handle client_socket(AF_INET, SOCK_STREAM, IPPROTO_TCP);
...
TEST_F(SocketHandleTest, ShutdownTagInvokeInvalidSocket) {
  socket_handle invalid_socket;
...
TEST_F(SocketHandleTest, ShutdownTagInvokePartialShutdown) {
  socket_handle server_socket(AF_INET, SOCK_STREAM, IPPROTO_TCP);
  socket_handle client_socket(AF_INET, SOCK_STREAM, IPPROTO_TCP);
