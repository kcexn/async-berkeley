...
/**
 * @file accept.hpp
 * @brief This file defines the `accept` customization point object for the I/O
 * library.
 */
#pragma once
 ...
 * for the `accept` CPO. It is not meant to be used directly by end-users.
 */
struct accept_t {};
 ...
 *
 * This struct acts as a customization point for accepting new connections. It
...
struct accept_fn {
   ...
   * argument to `tag_invoke` will be `::io::accept_t{}`, followed by the
