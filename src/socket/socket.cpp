...
auto tag_invoke([[maybe_unused]] bind_t tag, const socket_handle &socket,
...
auto tag_invoke([[maybe_unused]] listen_t tag, const socket_handle &socket,
                int backlog) -> int {
  return ::listen(static_cast<native_socket_type>(socket), backlog);
}

auto tag_invoke([[maybe_unused]] connect_t tag, const socket_handle &socket,
                const sockaddr_type *addr, socklen_type len) -> int {
...
auto tag_invoke([[maybe_unused]] accept_t tag, const socket_handle &socket,
...
auto tag_invoke([[maybe_unused]] sendmsg_t tag, const socket_handle &socket,
...
auto tag_invoke([[maybe_unused]] recvmsg_t tag, const socket_handle &socket,
                socket_message_type *msg, int flags) -> std::streamsize {
  return ::io::socket::recvmsg(static_cast<native_socket_type>(socket), msg,
                               flags);
}

auto tag_invoke([[maybe_unused]] getsockopt_t tag, const socket_handle &socket,
...
auto tag_invoke([[maybe_unused]] setsockopt_t tag, const socket_handle &socket,
...
auto tag_invoke([[maybe_unused]] getsockname_t tag, const socket_handle &socket,
                sockaddr_type *addr, socklen_type *len) -> int {
  return ::getsockname(static_cast<native_socket_type>(socket), addr, len);
}

auto tag_invoke([[maybe_unused]] getpeername_t tag, const socket_handle &socket,
                sockaddr_type *addr, socklen_type *len) -> int {
  return ::getpeername(static_cast<native_socket_type>(socket), addr, len);
}

auto tag_invoke([[maybe_unused]] shutdown_t tag, const socket_handle &socket,
                int how) -> int {
