 ...
 */
#pragma once
#ifndef ABRK_SOCKET_DIALOG_HPP
#define ABRK_SOCKET_DIALOG_HPP
 ...
 * @brief The `abrk::socket` namespace provides a cross-platform abstraction for
...
template <Multiplexer Mux> struct socket_dialog {
  ...
  using executor_type = ::abrk::execution::executor<Mux>;
