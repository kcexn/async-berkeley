 ...
 */
#pragma once
#ifndef ABRK_SYNC_OPERATIONS_HPP
#define ABRK_SYNC_OPERATIONS_HPP
...
auto tag_invoke([[maybe_unused]] fcntl_t *ptr, const Socket &socket,
                Args &&...args) -> int
{
  return ::abrk::socket::fcntl(static_cast<native_socket_type>(socket),
...
#endif // ABRK_SYNC_OPERATIONS_HPP
