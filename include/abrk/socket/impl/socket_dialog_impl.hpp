 ...
 */
#pragma once
#ifndef ABRK_SOCKET_DIALOG_IMPL_HPP
#define ABRK_SOCKET_DIALOG_IMPL_HPP
...
{
  if (!socket)
    throw std::invalid_argument(ABRK_ERROR_MESSAGE("Invalid socket pointer."));
...
#endif // ABRK_SOCKET_DIALOG_IMPL_HPP
