 ...
 */
#pragma once
#ifndef ABRK_CONCEPTS_POSIX_HPP
#define ABRK_CONCEPTS_POSIX_HPP
#include <type_traits>
...
/**
 * @brief Concept for POSIX socket address types.
 *
 * This concept is satisfied if the type is one of the standard POSIX socket
 * address structures, such as `sockaddr`, `sockaddr_in`, `sockaddr_in6`,
 * `sockaddr_un`, or `sockaddr_storage`.
 *
