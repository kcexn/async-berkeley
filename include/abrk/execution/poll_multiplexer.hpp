 ...
 */
#pragma once
#ifndef ABRK_POLL_MULTIPLEXER_HPP
#define ABRK_POLL_MULTIPLEXER_HPP
...
public:
  ...
  using native_socket_type = ::abrk::socket::native_socket_type;
...
#include "abrk/execution/impl/poll_multiplexer_impl.hpp" // IWYU pragma: export

#endif // ABRK_POLL_MULTIPLEXER_HPP
