 ...
 */
#pragma once
#ifndef ABRK_EXECUTOR_HPP
#define ABRK_EXECUTOR_HPP
#include "abrk/detail/concepts.hpp"
...
public:
  ...
  {
    if (::abrk::fcntl(*socket, F_SETFL,
                    ::abrk::fcntl(*socket, F_GETFL) | O_NONBLOCK))
    {
      throw_system_error(ABRK_ERROR_MESSAGE("fcntl failed."));
    }
    return socket;
  }
  /**
