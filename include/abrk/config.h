 ...
 */
#pragma once
#ifndef ABRK_CONFIG_H
#define ABRK_CONFIG_H
...
/**
 * @ingroup config
 * @def ABRK_EAGER_ACCEPT
 * @brief True if asynchronous accepts should be eagerly attempted.
 */
#ifndef ABRK_EAGER_ACCEPT
#define ABRK_EAGER_ACCEPT 1
#endif
 ...
 */
#ifndef ABRK_EAGER_SEND
#define ABRK_EAGER_SEND 1
#endif
 ...
 */
#ifndef ABRK_EAGER_RECV
#define ABRK_EAGER_RECV 1
#endif
